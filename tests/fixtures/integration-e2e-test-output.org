...
- *To Tag*: Add the =:tags= header for policy/trust-policy blocks, or press =C-c C-t= to tag the role directly.
  - *Format*: =:tags= is a quoted AWS tag string (e.g. "Key=Owner,Value=Dev key=stage,value=prod"). =Key/value= and =key/value= are both accepted.
...
- =:tags=         :: A *quoted* string of tags (e.g. "Key=Owner,Value=Dev key=stage,value=prod").
...
:LastUsedDate: nil
:LastUsedRegion: nil
:Tags: {"repo":"aws-iam-mode/terraform/main.tf","user_id_of_creator":"williseedAdminIDC","assumed_role_of_creator":"AWSReservedSSO_personal-full-admin_a401bb7d90ea7c07","environment":"personal","managed":"terraform"}
:END:
** Permission Policies
...
:Updated: 2025-12-02T16:49:09+00:00
:AttachmentCount: 1
:DefaultVersion: v14
:Tags: null
:END:
