...
- =:tags=         :: A string of tags (e.g. "Key=Owner,Value=Dev Key=Stage,Value=Prod").
...
:Updated: 2025-11-20T19:34:11+00:00
:AttachmentCount: 1
:DefaultVersion: v13
:Tags: null
:END:
...
#+END_SRC
*** test-iam-package-example-policy-name
:PROPERTIES:
:AWSPolicyType: Customer Managed
:ID: ANPAQCPT3RMBO3HOWDIYX
:ARN: arn:aws:iam::005343251202:policy/test-iam-package-example-policy-name
:Path: /
:Description: Policy to test added access to roles
:Created: 2025-11-30T20:46:20+00:00
:Updated: 2025-11-30T20:46:20+00:00
:AttachmentCount: 1
:DefaultVersion: v1
:Tags: {"environment":"personal","managed":"terraform","repo":"aws-iam-mode/terraform/main.tf"}
:END:
#+BEGIN_SRC aws-iam :role-name "test-iam-packageIamRole" :policy-name "test-iam-package-example-policy-name" :policy-type "customer-managed" :arn "arn:aws:iam::005343251202:policy/test-iam-package-example-policy-name" :results output
{
  "Statement": [
    {
      "Action": "s3:List*",
