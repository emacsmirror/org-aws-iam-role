...
:Tags: {"environment":"personal","managed":"terraform","repo":"aws-iam-mode/terraform/main.tf","user_id_of_creator":"williseedAdminIDC","assumed_role_of_creator":"AWSReservedSSO_personal-full-admin_a401bb7d90ea7c07","test":"test"}
:END:
** Permission Policies
...
:Updated: 2025-10-08T17:34:07+00:00
:AttachmentCount: 1
:DefaultVersion: v12
:END:
  ...
  "Statement": [
    {
      "Effect": "Allow",
      "Principal": {
        "AWS": "arn:aws:iam::005343251202:role/aws-reserved/sso.amazonaws.com/AWSReservedSSO_personal-full-admin_a401bb7d90ea7c07"
      },
