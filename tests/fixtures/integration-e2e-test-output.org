...
- *To Update a Policy*: Edit the JSON. If the policy has reached the version limit, you will be offered to delete the oldest version.
- *To Tag*: Add the =:tags= header for policy/trust-policy blocks, or press =C-c C-t= to tag the role directly.
  - *Format*: =:tags= is a quoted list of tag pairs separated by =", "= (e.g. "owner=hello there, name=noneya").

Use header arguments for specific actions:
- =:delete t=     :: Deletes the policy. If versions exist, you will be asked to recursively delete them.
- =:detach t=     :: Detaches the policy from the current role. Can be combined with =:delete t=.
- =:tags=         :: A *quoted* string of tags (e.g. "owner=hello there, name=noneya").
- =:path=         :: The IAM path for creation (e.g. "/service-role/"). Defaults to "/".

** Keybindings
- =C-c C-e= or =C-c e= :: Toggle read-only mode to allow/prevent edits.
...
:RoleID: AROAQCPT3RMBE6GFX4XOW
:Path: /
:Created: 2025-11-30T20:46:20+00:00
:MaxSessionDuration: 3600
:Description: nil
:PermissionsBoundaryArn: arn:aws:iam::005343251202:policy/DevOpsPermBoundary
:LastUsedDate: nil
:LastUsedRegion: nil
:Tags: {"hello":"yes no","owner":"no","champ":"true","repo":"aws-iam-mode/terraform/main.tf","user_id_of_creator":"williseedAdminIDC","assumed_role_of_creator":"AWSReservedSSO_personal-full-admin_a401bb7d90ea7c07","environment":"personal","managed":"terraform"}
:END:
** Permission Policies
...
:Updated: 2026-02-12T18:01:50+00:00
:AttachmentCount: 1
:DefaultVersion: v24
:Tags: null
:END:
...
#+END_SRC
*** test-iam-package-extra-policy-3
:PROPERTIES:
:AWSPolicyType: Customer Managed
:ID: ANPAQCPT3RMBPPLBKCTX5
:ARN: arn:aws:iam::005343251202:policy/test-iam-package-extra-policy-3
:Path: /
:Description: Extra policy 3
:Created: 2025-11-30T20:46:20+00:00
:Updated: 2025-11-30T22:02:00+00:00
:AttachmentCount: 1
:DefaultVersion: v2
:Tags: {"environment":"personal","managed":"terraform","repo":"aws-iam-mode/terraform/main.tf"}
:END:
#+BEGIN_SRC aws-iam :role-name "test-iam-packageIamRole" :policy-name "test-iam-package-extra-policy-3" :policy-type "customer-managed" :arn "arn:aws:iam::005343251202:policy/test-iam-package-extra-policy-3" :results output
{
  "Statement": [
    {
...
#+END_SRC
*** test-iam-package-example-policy-name-2
:PROPERTIES:
:AWSPolicyType: Customer Managed
:ID: ANPAQCPT3RMBP4NWCJ7NU
:ARN: arn:aws:iam::005343251202:policy/service-role/test-iam-package-example-policy-name-2
:Path: /service-role/
:Description: nil
:Created: 2025-11-30T21:16:27+00:00
:Updated: 2025-11-30T21:16:27+00:00
:AttachmentCount: 1
:DefaultVersion: v1
:Tags: null
:END:
#+BEGIN_SRC aws-iam :role-name "test-iam-packageIamRole" :policy-name "test-iam-package-example-policy-name-2" :policy-type "customer-managed" :arn "arn:aws:iam::005343251202:policy/service-role/test-iam-package-example-policy-name-2" :results output
{
  "Statement": [
    {
      "Action": "s3:List*",
      "Effect": "Allow",
      "Resource": "*",
      "Sid": "AdditionalAccess"
    }
  ],
  "Version": "2012-10-17"
}
#+END_SRC
*** test-iam-package-example-policy-name-2-3
:PROPERTIES:
:AWSPolicyType: Customer Managed
:ID: ANPAQCPT3RMBLI4J5GKZX
:ARN: arn:aws:iam::005343251202:policy/random/custom/path/test-iam-package-example-policy-name-2-3
:Path: /random/custom/path/
:Description: nil
:Created: 2025-11-30T21:20:07+00:00
:Updated: 2025-11-30T21:20:07+00:00
:AttachmentCount: 1
:DefaultVersion: v1
:Tags: {"Environment":"Test","Owner":"DevOps"}
:END:
#+BEGIN_SRC aws-iam :role-name "test-iam-packageIamRole" :policy-name "test-iam-package-example-policy-name-2-3" :policy-type "customer-managed" :arn "arn:aws:iam::005343251202:policy/random/custom/path/test-iam-package-example-policy-name-2-3" :results output
{
  "Version": "2012-10-17",
  "Statement": [
    {
...
:PROPERTIES:
:AWSPolicyType: Customer Managed
:ID: ANPAQCPT3RMBFGPOQTALN
:ARN: arn:aws:iam::005343251202:policy/random/custom/path/test-babel-policy
:Path: /random/custom/path/
:Description: nil
:Created: 2025-11-30T22:05:33+00:00
:Updated: 2025-11-30T22:05:33+00:00
:AttachmentCount: 1
:DefaultVersion: v1
:Tags: {"Environment":"Test","Owner":"DevOps"}
:END:
#+BEGIN_SRC aws-iam :role-name "test-iam-packageIamRole" :policy-name "test-babel-policy" :policy-type "customer-managed" :arn "arn:aws:iam::005343251202:policy/random/custom/path/test-babel-policy" :results output
{
  "Version": "2012-10-17",
  "Statement": [
    {
...
:Tags: nil
:END:
#+BEGIN_SRC aws-iam :role-name "test-iam-packageIamRole" :policy-name "test-iam-package-inline5" :policy-type "inline" :arn "" :results output
{
  "Version": "2012-10-17",
  "Statement": [
    {
...
:Tags: nil
:END:
#+BEGIN_SRC aws-iam :role-name "test-iam-packageIamRole" :policy-name "test-iam-package-inline9" :policy-type "inline" :arn "" :results output
{
  "Version": "2012-10-17",
  "Statement": [
    {
